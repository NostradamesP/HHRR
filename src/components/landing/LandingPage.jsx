...
import { User, KanbanSquare, BarChart3, FileText, Users } from "lucide-react";
                    ...
                    {["Pendiente", "En progreso", "Bloqueado", "Hecho"].map((status, i) => (
                      <div key={status} className="space-y-2">
                        <div className="flex items-center gap-1.5">
                          <div
                            className={`h-2 w-2 rounded-full ${i === 0 ? "bg-slate-400" : i === 1 ? "bg-cyan-500" : i === 2 ? "bg-amber-500" : "bg-emerald-500"}`}
                          />
